...
const Register = () => {
    ...
    useEffect(() => {
        ...
        const initialRole = (location.state?.role === 'admin' || location.state?.role === 'superadmin')
            ? 'citizen'
    ...
    const roles = [
        { id: 'citizen', label: 'Citizen', icon: User, activeClass: 'bg-blue-500/20 text-blue-300 border-blue-500/50' },
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                >
                    <Button
                        ...
                        icon={ArrowLeft}
                    >
                        <span className="group-hover:-translate-x-1 transition-transform inline-block">Back to Login</span>
                    </Button>
                </motion.div>
                    ...
                    <GlassCard className="p-8 md:p-10 backdrop-blur-2xl border-white/10 shadow-2xl shadow-indigo-500/10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-400">
                                Join as a <span className="text-indigo-400 font-semibold capitalize">{role}</span>
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <Input
                                ...
                                required
                                icon={User}
                                className="bg-white/5 border-white/10 focus:border-indigo-500/50 focus:bg-white/10 h-11"
                            />
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-indigo-500/25 border-none text-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] mt-4"
                                isLoading={loading}
                            >
                                Create Account
                            </Button>
